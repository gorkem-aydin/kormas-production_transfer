		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Üretim Transfer",
									"targetURL": "#comkormasproductiontrns-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkormasproductiontrns-display": {
								"semanticObject": "comkormasproductiontrns",
								"action": "display",
								"description": "Üretim Transfer",
								"title": "Üretim Transfer",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kormas.productiontrns",
									"url": sap.ui.require.toUrl("com/kormas/productiontrns")
								}
							}
						}
					}
